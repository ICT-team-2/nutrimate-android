...
public class FollowPageAdapter extends RecyclerView.Adapter<FollowPageAdapter.MyViewHolder> {
    private Context context;
    private List<BoardInfoListItem> items;
    private BoardFeedItemBinding binding;

    public FollowPageAdapter(Context context, List<BoardInfoListItem> items) {
