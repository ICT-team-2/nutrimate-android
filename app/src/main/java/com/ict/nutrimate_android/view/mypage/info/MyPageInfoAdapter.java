...
public class MyPageInfoAdapter extends RecyclerView.Adapter<MyPageInfoAdapter.MyViewHolder>{
    private Context context;
    private List<BoardInfoListItem> items;
    private BoardFeedItemBinding binding;

    public MyPageInfoAdapter(Context context, List<BoardInfoListItem> items) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyPageInfoAdapter.MyViewHolder(view);
    }
