...
public class MyPageBookmarkFeedAdapter extends RecyclerView.Adapter<MyPageBookmarkFeedAdapter.MyViewHolder> {
    private Context context;
    private List<BoardFeedListItem> items;
    private BoardFeedItemBinding binding;

    public MyPageBookmarkFeedAdapter(Context context, List<BoardFeedListItem> items) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyPageBookmarkFeedAdapter.MyViewHolder(view);
    }
